...
/**
 * 商户模板数据缓存处理器
 * Class MerchantTemplateCacheHandler
 * @package App\Handler\Cache\Data\Pros\WhatsApp
 */
class MerchantTemplateCacheHandler extends BaseCacheHandler
{
    /**
     * 构造函数
     * MerchantTemplateCacheHandler constructor.
     * @throws \Exception
     */
    public function __construct()
    {
        //引入父级构造
        parent::__construct('pros:whatsapp:merchant_templates_data_cache', 13593, 'file');
        //初始化缓存
        $this->init();
    }
