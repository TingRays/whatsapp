...
/**
 * 粉丝管理数据缓存处理器
 * Class FansManageCacheHandler
 * @package App\Handler\Cache\Data\Pros\WhatsApp
 */
class FansManageCacheHandler extends BaseCacheHandler
{
    /**
     * 构造函数
     * FansManageCacheHandler constructor.
     * @throws \Exception
     */
    public function __construct()
    {
        //引入父级构造
        parent::__construct('pros:whatsapp:fans_manage_data_cache', 85418, 'file');
        //初始化缓存
        $this->init();
    }
