...
/**
 * 商业管理（BM）账户数据缓存处理器
 * Class BusinessManagerCacheHandler
 * @package App\Handler\Cache\Data\Pros\WhatsApp
 */
class BusinessManagerCacheHandler extends BaseCacheHandler
{
    /**
     * 构造函数
     * BusinessManagerCacheHandler constructor.
     * @throws \Exception
     */
    public function __construct()
    {
        //引入父级构造
        parent::__construct('pros:whatsapp:business_manager_data_cache', 75018, 'file');
        //初始化缓存
        $this->init();
    }
