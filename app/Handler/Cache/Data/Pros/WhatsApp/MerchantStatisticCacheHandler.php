...
/**
 * 商户统计数据缓存处理器
 * Class MerchantStatisticCacheHandler
 * @package App\Handler\Cache\Data\Pros\WhatsApp
 */
class MerchantStatisticCacheHandler extends BaseCacheHandler
{
    /**
     * 构造函数
     * MerchantStatisticCacheHandler constructor.
     * @throws \Exception
     */
    public function __construct()
    {
        //引入父级构造
        parent::__construct('pros:whatsapp:merchant_statistics_data_cache', 27238, 'file');
        //初始化缓存
        $this->init();
    }
