...
/**
 * 群发信息数据缓存处理器
 * Class MassDispatchCacheHandler
 * @package App\Handler\Cache\Data\Pros\WhatsApp
 */
class MassDispatchCacheHandler extends BaseCacheHandler
{
    /**
     * 构造函数
     * MassDispatchCacheHandler constructor.
     * @throws \Exception
     */
    public function __construct()
    {
        //引入父级构造
        parent::__construct('pros:whatsapp:mass_dispatch_data_cache', 69543, 'file');
        //初始化缓存
        $this->init();
    }
