...
/**
 * 虚拟手机号数据缓存处理器
 * Class FictitiouCacheHandler
 * @package App\Handler\Cache\Data\Pros\WhatsApp
 */
class FictitiouCacheHandler extends BaseCacheHandler
{
    /**
     * 构造函数
     * FictitiouCacheHandler constructor.
     * @throws \Exception
     */
    public function __construct()
    {
        //引入父级构造
        parent::__construct('pros:whatsapp:fictitious_data_cache', 12895, 'file');
        //初始化缓存
        $this->init();
    }
