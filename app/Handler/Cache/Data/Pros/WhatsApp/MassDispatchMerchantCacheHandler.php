...
/**
 * 群发信息商户数据缓存处理器
 * Class MassDispatchMerchantCacheHandler
 * @package App\Handler\Cache\Data\Pros\WhatsApp
 */
class MassDispatchMerchantCacheHandler extends BaseCacheHandler
{
    /**
     * 构造函数
     * MassDispatchMerchantCacheHandler constructor.
     * @throws \Exception
     */
    public function __construct()
    {
        //引入父级构造
        parent::__construct('pros:whatsapp:mass_dispatch_merchant_data_cache', 72375, 'file');
        //初始化缓存
        $this->init();
    }
