...
/**
 * 管理员授权签名数据缓存处理器
 * Class AdminOauthSignatureCacheHandler
 * @package App\Handler\Cache\Data\Pros\Console
 */
class AdminOauthSignatureCacheHandler extends BaseCacheHandler
{
    /**
     * 构造函数
     * AdminOauthSignatureCacheHandler constructor.
     * @throws \Exception
     */
    public function __construct()
    {
        //引入父级构造
        parent::__construct('pros:console:admin_oauth_signatures_data_cache', 75218, 'file');
        //初始化缓存
        $this->init();
    }
