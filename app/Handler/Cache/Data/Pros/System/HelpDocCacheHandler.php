...
/**
 * 帮助文档数据缓存处理器
 * Class HelpDocCacheHandler
 * @package App\Handler\Cache\Data\Pros\System
 */
class HelpDocCacheHandler extends BaseCacheHandler
{
    /**
     * 构造函数
     * HelpDocCacheHandler constructor.
     * @throws \Exception
     */
    public function __construct()
    {
        //引入父级构造
        parent::__construct('pros:system:help_docs_data_cache', 74111, 'file');
        //初始化缓存
        $this->init();
    }
