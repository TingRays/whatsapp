...
/**
 * 临时文件记录数据缓存处理器
 * Class TemporaryFileCacheHandler
 * @package App\Handler\Cache\Data\Pros\System
 */
class TemporaryFileCacheHandler extends BaseCacheHandler
{
    /**
     * 构造函数
     * TemporaryFileCacheHandler constructor.
     * @throws \Exception
     */
    public function __construct()
    {
        //引入父级构造
        parent::__construct('pros:system:temporary_files_data_cache', 54497, 'file');
        //初始化缓存
        $this->init();
    }
