    ...
    <div class="container-fluid d-flex align-items-stretch justify-content-between">
        ...
        <div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1">
            @php
                ...
                $role_alias = data_get($current_auth, 'role_alias', 'administrator');
                if($role_alias === 'trailing_end'){
                    $pros_menus = config('pros_menus_trailing_end', []);
                }else{
                    $pros_menus = config('pros_menus', []);
                }
            @endphp
